    ...
    <Container maxW="container.xl" p={5}>
      <VStack spacing={5}>
        ...
        <Flex w="full" wrap="wrap" gap={10}>
          {/* Main Chat Interface */}
          <Box w={{ base: "full", md: "65%" }} p={8} borderWidth="1px" borderRadius="lg" boxShadow="md">
            <VStack spacing={4}>
              <Box w="full" h="500px" p={3} overflowY="auto" borderWidth="1px" borderRadius="lg" bg="gray.100">
